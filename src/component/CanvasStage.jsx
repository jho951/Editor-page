...
import { setZoom, setPan } from '../redux/slice/viewportSlice';
import { setTool } from '../redux/slice/toolSlice'; // ⬅ 편집 종료 시 select 로 전환
...
export default function CanvasStage() {
    ...
    const onPointerDown = (e) => {
        ...
        // 🔸 텍스트 편집 중엔 클릭하면 편집 종료 + select 전환 (새 텍스트는 만들지 않음)
        if (textEdit) {
            setTextEdit(null);
