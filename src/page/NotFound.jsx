...
export default function NotFound() {
    ...
    const tileSizeRef = useRef({
        ...
        height: MAX_TILE_WIDTH * ASPECT_RATIO,
    });
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            const tileW =
                screenWidth / (isMobile ? FIXED_COLS - 10 : FIXED_COLS);
