...
export const endpoints = {
  ...
  workspaceDocuments: (workspaceId: string) =>
    `${API_V1}/workspaces/${encodeURIComponent(workspaceId)}/documents`,
  workspaceTrashDocuments: (workspaceId: string) =>
    `${API_V1}/workspaces/${encodeURIComponent(workspaceId)}/trash/documents`,
  ...
  adminDocumentBlocks: (documentId: string) =>
    `${API_V1}/admin/documents/${encodeURIComponent(documentId)}/blocks`,
